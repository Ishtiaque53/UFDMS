<?php
    ...
    if(isset($_POST["submit"])) {
        ...
        $quary = "UPDATE `user` SET password = '".$password."' WHERE todate is null AND appt = 'POL'";
        $result1 = mysqli_query($con, $quary) or die(mysqli_error($con));

        if($result1) {
            $quary = "commit";
            mysqli_query($con, $quary) or die(mysqli_error($con));
            echo '<script>alert("POL NCO Password Change Successful");</script>';
            ...
            $quary = "rollback";
            mysqli_query($con, $quary) or die(mysqli_error($con));
            echo '<script>alert("POL NCO Password Change was not successful");</script>';
        }
    }
?>
...
<head>
    ...
    <title>POL NCO Password Change</title>
    <link rel="stylesheet" href="css/qm_pol_password.css">
</head>
<body>
    ...
    <section class="hero">
        <div class="container1">
            <div class="left-col">
                ...
                <form action="qm_pol_password.php" method="post">
